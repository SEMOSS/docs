...
1. Navigate to the [Pull Requests](INSERT CLIENT GIT HUB) tab in the official GitHub repo. Here, click "New Pull Request" and you will see "compare across forks" on the screen.
...
Our [documentation](CLIENT_GIT_REPO/) is refreshed nightly to provide the most current information. If you need documentation on a topic that is not currently covered, please follow the steps below:
