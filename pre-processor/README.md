...
c. In the Windows Start Search, type "Edit System Variables" and open the wizard to edit System Variables. Please enter your semoss credentials if prompted to do so.
...
1. Pratulya Shah (pbimalshah@semoss.com)
2. Sumit Gupta (sumitgupta4@semoss.com)
3. Shivam Chaudhary (shivamchaudhary3@semoss.com)
