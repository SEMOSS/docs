...
Now that we have access to pnpm we are ready to install all necessary SEMSEMOSSNameOSS packages. 
...
![VS Code terminal](/img/FELocalInstall/semossuiterminal.PNG)
...
This will go through all of the contents of the `package.lock` file and download them. For reference, here is the [package.lock file](https://github.com/semoss-Default/cfgai-ui/blob/dev/package.json)
...
![local env](/img/FELocalInstall/envlocal.png)
...
![Registering](/img/FELocalInstall/registering.png)
...
![Final Page](/img/FELocalInstall/finalPage.PNG)
