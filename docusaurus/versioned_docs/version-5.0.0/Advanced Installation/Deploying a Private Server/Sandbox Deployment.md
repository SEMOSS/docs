...
* Obtain Image Registry Credentials
* Login into https://quay.io/
* Copy the CLI secret from User Profile
* Log in to the Docker Registry and obtain CLI secret. Use the following command to log in to your Docker registry `docker login quay.io`
...
dockerImage=quay.io/semoss/semoss-dev:5.3.0-SNAPSHOT-ubuntu22-latest
````
