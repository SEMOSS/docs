...
![Tomcat Server](/img/BELocalInstall/ts1.png)
...
![Tomcat Server](/img/BELocalInstall/ts2.png)
...
- After you update you should follow these steps within Eclipse in order to ensure your Semoss and Monolith projects are fully operational,
	- Update Maven
	- You usually only need to do this when the pom.xml is updated, which you can check during the [`git pull` update process](#regarding-ai-core-update).
...
![SEMOSS](/img/SemossDevInstallation/Trick13.png)

![SEMOSS](/img/SemossDevInstallation/Trick14.png)
...
![SEMOSS](/img/SemossDevInstallation/Trick15.png)
...
![SEMOSS](/img/SemossDevInstallation/Trick16.png)

![SEMOSS](/img/SemossDevInstallation/Trick17.png)
...
![SEMOSS](/img/SemossDevInstallation/Trick18.png)

![SEMOSS](/img/SemossDevInstallation/Trick19.png)
...
![SEMOSS](/img/SemossDevInstallation/Trick20.jpg)

![SEMOSS](/img/SemossDevInstallation/Trick21.png)

- Edit JAVA_HOME variable with the path you copied before

![SEMOSS](/img/SemossDevInstallation/Trick22.png)

- Edit JRE_HOME with the path you copied before + \jre

![SEMOSS](/img/SemossDevInstallation/Trick23.png)
