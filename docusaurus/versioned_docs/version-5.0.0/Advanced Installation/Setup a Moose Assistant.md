...
import AppName, {WrapVariable, ShowVideoTag} from "@site/src/components/CustomFields";

import ReactPlayer from 'react-player'  

# Overview
Moose AI is an AI smart assistant widget that can be added to a SEMOSSName insight to assist the user with data inquiries. You can follow the steps below to set up Moose AI on your  instance. 


# Setup a Moose Assistant

**Stop any running instance of SEMOSSName on your machine**
- Open your browser and close all tabs that SEMOSSName open.
...
![SVNUpdate](/img/MooseAI/SVNUpdate.png)
...
![RDF Map](/img/MooseAI/RDFMap.png)
...
- Open **SEMOSSName instance** in your browser. Log out once and log back in.
