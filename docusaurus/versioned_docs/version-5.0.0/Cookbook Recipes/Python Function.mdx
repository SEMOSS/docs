...
description: Create and deploy Python functions within SEMOSSName to execute custom logic, data processing, or model-powered workflows.
...
Engine folders in SEMOSSName are named as "ENGINENAME___ENGINEID"
```
...
![Function Engine Zip](/img/FunctionEngines/zip_custom_py_function_engine.png)
7. Upload to SEMOSSName! [Add Zip File](../../documentation/platform-navigation/function-catalog#adding-a-zipped-function-engine)
...
```
10. Success!!!!
![Function Pixel](/img/FunctionEngines/customPyFunctionPixel.png)
