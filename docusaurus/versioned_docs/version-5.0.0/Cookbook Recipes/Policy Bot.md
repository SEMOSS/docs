---
title: Policy Bot
description: Build and deploy a Policy Bot application that answers policy questions using SEMOSSName’s Vector Engine and MCP integration.
...
- [**VS Code**](../javascript=guide#code-editor) or any preferred code editor  
...
![Open in VSCode](/img/Policy%20Bot/VSCode.png)
...
1. **Create your workspace and access Policy Bot**  
   ...
   ![VSCode Structure](/img/policyapp/policy7pic.PNG)
...
3. **Configure environment variables**  
   ...
   ![env Example](/img/policyapp/policy11pic.PNG)
...
4. **Run the app locally**  
  ...
  ```bash
   ...
   ![Running App](/img/policyapp/policy13pic.PNG)

5. **Customize Policy Bot**  
   Open the main page:  
  `policy/client/src/pages/PolicyPage.tsx`

   ![PolicyPage](/img/policyapp/policy14pic.PNG)
...
7. **Publish the application**  
   ...
   - You will now see the Policy Bot UI inside your App Library.  
     ...
     ![Published App](/img/Policy%20Bot/policyBot.png)
