...
description: Learn how to perform basic model inference in SEMOSSName and interact with LLMs programmatically.
...
- **[Connecting to SEMOSSName](../Integrating%20with%20SEMOSS/ConnectingToAI.md)**  
  Learn how to authenticate and connect to the SEMOSS SEMOSSName environment, including access tokens and required configuration.
