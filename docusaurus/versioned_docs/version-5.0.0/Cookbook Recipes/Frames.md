---
title: Frames
description: Understand what Frames are in SEMOSSName, how different frame types work, and how to create, modify, and validate Frames using the UI and Pixel commands.
