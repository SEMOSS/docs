...
description: Create an AI-powered Award Generator app using SEMOSSName, including prompt logic, design structure, and app integration steps.
...
![Award Generator](/img/awardgenerator/award0.png)
...
![Award Generator](/img/awardgenerator/award9.png)
...
![Award Generator](/img/awardgenerator/award10.png)

4. The app offers targeted recommendations to help improve the nomination process.

![Award Generator](/img/awardgenerator/awardrecomend.png)
...
![Award Generator](/img/awardgenerator/awardupdate.png)
...
![Award Generator](/img/awardgenerator/awardafterfeedback.png)
...
![Award Generator](/img/awardgenerator/awardprevcopy.png)
...
![Award Generator](/img/awardgenerator/awarddraft.png)
