...
description: Build, run, and deploy a GenAI application using React, TypeScript, and the SEMOSSName platform, including local development and publishing to the App Catalog.
...
See [Connecting to SEMOSSName](../Integrating%20with%20SEMOSS/ConnectingAI.md)
...
![Create New App](/img/AppUseCaseImages/app_building_options.png)
...
![Upload App Assets Button](/img/AppUseCaseImages/code_editor_asset_upload.png)
5. Attach your zip file in the modal that appears and hit "Upload."
![Upload App Assets Modal](/img/AppUseCaseImages/asset_upload_dialog.png)
6. Ta-da! You have successfully uploaded your code app to the SEMOSSName Server!

## Updating your App In  

Once you have finished making any updates to your app, these are the steps that you should follow to update your app in  . 
...
![Edit App](/img/UpdateApp/demoAPP_edit.PNG)
4. Once in the Edit App tab, navigate to the Settings Tab. 
![Settings Tab](/img/UpdateApp/DemoApp_settings.PNG)
5. Once in the settings section, you want to go to the Data Apps Section. 
![Data Apps](/img/UpdateApp/DemoApp_data.PNG)
...
![Update App](/img/UpdateApp/DemoApp_update.PNG)
