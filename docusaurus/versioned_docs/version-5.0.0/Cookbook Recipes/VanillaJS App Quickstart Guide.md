---
title: VanillaJS App Quickstart Guide
description: Build a GenAI web application using Vanilla JavaScript and integrate with SEMOSSName through Insights and Model Engine calls.
...
tags:
  ...
  - GenAI
  - SEMOSSName
slug: /cookbook/vanillajs-app-quickstart
---
...
![Demo App](/img/VanillaJS/Demo_App.png)

## Connecting to SEMOSSName

- [Generating Access and Secret Keys](../Integrating%20with%20SEMOSS/ConnectingToAI.md#generating-access-and-secret-keys)
...
- [Template file for demo app](https://github.com/SEMOSS/Template/blob/default-app/client/src/index.html)
> **Note**
> This is a protected GitHub, if you do not have access to it, or are not currently signed in to your semoss GitHub account you will get a 404 Error. Ask an admin for access.
...
![Importing Insight](/img/VanillaJS/ImportingInsight.PNG)

This is an integral portion to being able to access the models, storage catalogues, databases, etc that is stored in your SEMOSSName instance. If you'd like to know more about what an Insight is, and why it is useful, you can read more about it here:

[What is an Insight](../../../Archived%20Material/Key%20Concepts.md#what-is-an-insight)

There is also some documentation on what actions having access to Insight allows you to do here:

[Usefulness of an Insight](../Integrating%20with%20SEMOSS/Using%20the%20SDK.md#using-insights)

For now, however, we just want to make note that we are importing an Insight, and later on creating an insight, allowing us the ability to access the information stored in our SEMOSSName app, whether that be where our app is hosted or if we were to run the app locally. 

## Calling an LLM 

Now that we have imported an Insight into our app, we have access to the LLMs stored in the model catalogue of our SEMOSSName instance. 

![Model Catalog](/img/VanillaJS/ModelCatalog.png)
...
![Requesting Access](/img/VanillaJS/RequestingAccess.PNG)
...
![Model Id](/img/VanillaJS/ModelID.PNG)
...
![Engine ID](/img/VanillaJS/Engine_ID.PNG)
...
![Portals](/img/VanillaJS/Portals_folder.png)
...
![Zip Files](/img/VanillaJS/Zip_file.png)

You are now ready to upload your app.

**Once you have added all your files into the structure:**

1. Navigate to https://MonoLithURL/SemossWeb/packages/client/dist/#/

2. Click "Add App"
![Add App](/img/VanillaJS/Add_App.png)

3. Fill in the required fields 
![Requirements](/img/VanillaJS/Adding_Demo_App.PNG)

4. Upload your zip file 

5. Click "Upload" (Note: this may take a few minutes to spin up). 

6. Ta-da! You have successfully created an app in the SEMOSSName Server! (Note:If you get an error, click to go back on your browser and you should be able to see you app in the catalogue)
![Final](/img/VanillaJS/DemoApp_Added.PNG)
