---
title: Creating a Vector Database
description: Learn how to create, populate, and query a vector database inside SEMOSSName using embeddings and semantic search.
sidebar_label: Creating a Vector Database
sidebar_position: 7
tags:
  - Vector Database
  - Embeddings
