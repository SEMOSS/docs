...
description: Learn how to implement Retrieval Augmented Generation workflows using SEMOSSName, create embeddings, and query knowledge sources.
...
### Create an Agent
 ...
 3. Now, click **Get Started** Under **Construct an Agent**
  ![Creating an agent](/autoImg/RAG/ConstructAnAgent.png)
 ...
 5. Click Next
  ![Creating HR Agent App](/img/RAG/HRAppCreation.png)
 6. Set Inputs, Use your mouse to hover over the word "Prompt". Then select **Set Input** and Click **Next**.
  ![Setting Input to HR App](/autoImg/RAG/SettingPrompt.png)
...
![Testing HR App](/img/RAG/HRAppTest.png)
