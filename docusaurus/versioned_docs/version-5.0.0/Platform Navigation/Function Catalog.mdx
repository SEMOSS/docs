...
![Click Open Function](/autoImg/PlatformNavigation/Function%20Catalog/Function.png)
...
![Click Add Function](/autoImg/PlatformNavigation/Function%20Catalog/Add%20Function.png)
...
![Select a Function](/autoImg/PlatformNavigation/Function%20Catalog/Function%20Options.png)
...
![Finalize a Function](/img/FunctionEngines/create_func.png)
...
![Add a Zipped Function Engine](/img/FunctionEngines/add_zip.png)


## Usage
The usage tab in a specific function engine tells you how to use the function in JavaScript, Python and Java.

![Usage of a Function](/autoImg/PlatformNavigation/Function%20Catalog/Usage.png)
...
- ENGINE_ALIAS: engine name displayed in SEMOSSName
- ENGINE_TYPE: Java class that implements SEMOSSName engine interface (IEngine)
...
![Function Assets](/img/FunctionEngines/function_assets.png)
...
Each function in SEMOSSName is assigned a unique **Function ID**.  
This ID is required whenever you call the function programmatically in JavaScript, Python, or other supported SDKs.

You can find the Function ID in two places:

### In the Function Overview Page
When you open a function from the **Function Catalog**, the Function ID appears directly under the function name, along with a **Copy Function ID** button for convenience.

![Function ID](/img/FunctionEngines/GetFunctionID.png)

### Inside the Usage Tab
The **Usage** tab contains ready-to-use code snippets that automatically include the correct Function ID.  
This allows you to copy these examples directly into your application.
...
![App Access](/autoImg/PlatformNavigation/Function%20Catalog/Pending%20Requests.png)
...
![Discoverable Functions](/autoImg/PlatformNavigation/Function%20Catalog/Discoverable%20Functions.png)
...
![Request Access](/autoImg/PlatformNavigation/Function%20Catalog/Access%20Request.png)
...
![Edit](/autoImg/PlatformNavigation/Function%20Catalog/Edit.png)
...
![EditInterface](/autoImg/PlatformNavigation/Function%20Catalog/Edit%20Function%20Options.png)
...
![Export](/autoImg/PlatformNavigation/Function%20Catalog/Export.png)
