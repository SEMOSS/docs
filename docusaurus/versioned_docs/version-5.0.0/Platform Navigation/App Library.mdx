...
import {ShowVideoTag, WrapVariable} from "@site/src/components/CustomFields";

# App Library

App Library is a section in SEMOSSName which consists of list of Gen AI applications present on the platform that are created by users. Once you click on a particular app in the App Library, it will open the App which is ready to use.

## Creating a new App

To create a new App, click on the top right corner of the homepage on **Create New App**.

![New App Button](/autoImg/PlatformNavigation/App%20Library/Create%20New%20App.png)
...
1. Code - You can build an app by coding using a framework or even from strach
    ...
    How to build a Code App has been covered in detail [here](../Building%20Apps/Pro%20Code%20Apps.md).

2. Drag and Drop - This is no-code option of creating a new app

    How to build a Drag and Drop App has been covered in detail [here](../Building%20Apps/Drag%20and%20Drop/No%20Code%20App.mdx).

3.  Agent Builder - This is also a no-code solution

    How to build an Agent Builder App has been covered in detail [here](../Building%20Apps/Agent%20Builder.mdx).

4. Template App

    If you don't want to build your app from scratch, you can choose utilize a template from the list of templates.

![Create New App Options](/autoImg/PlatformNavigation/App%20Library/Start%20build%20with%20a%20template.png)
...
![New App Popup](/autoImg/PlatformNavigation/App%20Library/New%20App%20Popup.png)
...
![Preview App](/autoImg/PlatformNavigation/App%20Library/Preview%20App.png)
...
![Share App](/autoImg/PlatformNavigation/App%20Library/Share%20App.png)
...
![Sharing via Url](/img/AppSharing/UrlSharing.png)
...
![Sharing via Iframe](/img/AppSharing/IframeSharing.png)
...
![Save App](/autoImg/PlatformNavigation/App%20Library/Save%20App.png)
...
![Show App](/autoImg/PlatformNavigation/AppLibrary/ShowApp.png) */}

## Getting App ID
Navigate to the App Library page
Click on the settings button on an app tab

![App Settings Button](/img/PlatformNavigation/AppLibrary/AppId.png)
...
![Upload App](/autoImg/PlatformNavigation/App%20Library/Upload%20App.png)
...
![Uploading App](/autoImg/PlatformNavigation/App%20Library/Uploading%20App.png)

## Access Control
<ShowVideoTag><ReactPlayer controls url="/Demos/AppLibraryAndUserPermissions.mp4" /></ShowVideoTag>
...
{/* TODO */}
{/* ![Access Control](/img/FunctionEngines/functionAccessControl.png) */}
...
![App Access](/autoImg/PlatformNavigation/App%20Library/Pending%20Requests.png)
...
![Request Access](/img/FunctionEngines/functionRequestAccess.png)
...
![Edit](/autoImg/PlatformNavigation/App%20Library/Edit.png)
...
![EditInterface](/autoImg/PlatformNavigation/App%20Library/App%20Edit%20Options.png)
...
![Export](/autoImg/PlatformNavigation/App%20Library/Export.png)
...
![App Search](/autoImg/PlatformNavigation/App%20Library/Search.png)


## Removing an App
<ShowVideoTag><ReactPlayer controls url="/Demos/RemovingApp.mp4" /></ShowVideoTag>

{/* <br/> */}

If you ever want to remove an App from your SEMOSSName server, the first thing that you should do is navigate to your settings sections (the gear).

![Settings Tool](/autoImg/PlatformNavigation/App%20Library/Settings.png)

> _The settings tool_

Inside Settings, you should see a screen that has a settings sections for each of the resources you have in SEMOSSName. Click on App Settings.

![App Settings](/autoImg/PlatformNavigation/App%20Library/App%20Settings.png)
...
![Delete Button](/autoImg/PlatformNavigation/App%20Library/Delete.png)
...
This process can be replicated for all other resource types (databases, models, storage catalogs, etc) in SEMOSSName!
