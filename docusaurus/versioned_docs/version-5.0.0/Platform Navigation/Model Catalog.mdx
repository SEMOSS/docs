...
![Model Library](/autoImg/PlatformNavigation/Model%20Catalog/Model.png)
...
![Model Catalog Page](/autoImg/PlatformNavigation/Model%20Catalog/Model%20Catalog.png)

## Adding a Model
Click on **Add Model**, choose your preferred model from the list and fill in the required details to connect to the model.

![Model Options](/autoImg/PlatformNavigation/Model%20Catalog/Model%20Options.png)

> _Various Model Options_

{/* <ReactPlayer controls url="/Demos/ModelsDemo.mp4" /> */}
...
![Model Chat](/img/ModelCatalogImages/Chat.png)
...
![Model Chat Example](/img/ModelCatalogImages/Chat%20Example.png)
...
![Usage of a Model](/autoImg/PlatformNavigation/Model%20Catalog/Usage.png)

## Getting the Model ID

Every model in SEMOSSName is assigned a unique **Model ID**.  
...
![Model ID](/img/ModelCatalogImages/GetModelId.png)
...
![Model Access](/autoImg/PlatformNavigation/Model%20Catalog/Pending%20Requests.png)
...
![Discoverable Models](/autoImg/PlatformNavigation/Model%20Catalog/Discoverable%20Models.png)
...
![Request Access](/autoImg/PlatformNavigation/Model%20Catalog/Access%20Request.png)
## Edit Model
...
![Edit](/autoImg/PlatformNavigation/Model%20Catalog/Edit.png)
...
![EditInterface](/autoImg/PlatformNavigation/Model%20Catalog/Edit%20Model%20Options.png)
...
![Export](/autoImg/PlatformNavigation/Model%20Catalog/Export.png)
