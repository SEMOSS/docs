...
* To access the BI tool, login to the [SEMOSSName](https://MonoLithURL/SemossWeb/packages/client/dist/#/) platform
* Once you're in the App Library, you will see two system apps on the top - **BI** and **Terminal**.
* Click on **BI**.

![AppLibraryl](/img/Navigating/AppLibrary_BI.png)
...
![NewProject](/img/Navigating/CreateProject.png)
...
![CreateInsight](/img/Navigating/CreateInsight.png)
...
![Adding a Panel](/img/Navigating/panel.png)
> Here we added a second panel which shows our data

* For dashboarding, you can move around / drag and drop your panels and visuals in a manner that you like and click on **Present** to share it within your SEMOSSName environment.
![Presentation Mode](/img/Navigating/Presentation.png)
...
![Export](/img/Navigating/exporting.png)
> By going into export, we can make this into a shareable file.

<ShowVideoTag><ReactPlayer controls url="/Demos/BIToolDemo.mp4" /></ShowVideoTag>
...
![Text2SQL](/img/Navigating/SEMOSS%20AI%20Apps/Text%20to%20SQL.PNG)
> Text2SQL App response based on uploaded file and question asked

<ShowVideoTag><ReactPlayer controls url="/Demos/Text2SQLAppDemo.mp4" /></ShowVideoTag>
...
![Policy Vector Engine](/img/Navigating/SEMOSS%20AI%20Apps/PolicyVectorEngine.PNG)
> Policy Vector Engine response to a question

<ShowVideoTag><ReactPlayer controls url="/Demos/PolicyVectorEngine.mp4" /></ShowVideoTag>

### 3. Playground
This App is used to test various prompts with different AI models using chats. You can select type of model from drop down based on type of prompt that will be used and check if its working correctly. If a model dosn't support a particular prompt, it will provide that information in response. Its Front-end is a React App and backend is connected SEMOSSName without any code. You can click on settings icon highlighted below to edit LLM parameters like temperature, token length etc.

![Playground App](/img/Navigating/SEMOSS%20AI%20Apps/Playground.PNG)
...
![Report Generator App](/img/Navigating/SEMOSS%20AI%20Apps/Report_Generator_Response.PNG)
> Report Generator App response to a meetring transcript as a prompt

<ShowVideoTag><ReactPlayer controls url="/Demos/ReportGeneratorApp.mp4" /></ShowVideoTag>


## Access and Download Apps Locally
To access all SEMOSSName Apps or download them in your local environment, we can use below mentioned ways -
...
![Copy Apps Folder link](/img/Navigating/Copy%20Apps%20Folder%20code.PNG)
> Apps folder link

Now open the folder in your local environment where you want to download these Apps and run the windows terminal.
![Github Folder](/img/Navigating/Github%20Folder.PNG)
...
![Github Authnetication](/img/Navigating/Sign%20into%20Github.PNG)
...
![Apps Successfully Cloned](/img/Navigating/Successfully%20Cloned.PNG)
> Apps are successfully cloned locally

You can see below, cfgai-apps folder with other Apps in the folder.
![Apps cloned locally](/img/Navigating/All%20Apps%20cloned.PNG)
...
![Downloaded Zip File](/img/Navigating/Downloaded%20Zip%20File.PNG)
> Downloaded Zip File

Now unzip the file in the same folder and it will return cfgai-apps folder which will consist of all Apps in the folder.
![Unzipped Folder](/img/Navigating/unzipped%20folder.PNG)
> Downloaded Apps after unzipping the Folder


### Configure SMSS File
SMSS file allows SEMOSSName to use resources of many different types, and allows users to configure certain properties of those resources being used. It is a file that sets the properties for resources like SEMOSSName Engine, Project, Insight, Model, etc. It contains a list of key value pairs that set the context for SEMOSSName objects.

For example, an engine's smss file may contain the ID in the SEMOSSName database, the alias for the engine, JDBC connection, the location of the database file, username, password, etc. This allows SEMOSSName to know how to connect to the object that the SMSS file references.
