...
<ShowVideoTag><ReactPlayer controls url="/Demos/IntroToDragAndDrop.mp4" /></ShowVideoTag>
<br/>
...
![App Library Home](/img/AppUseCaseImages/AppBuildingOptionsNew.png)

3. Add a name for your new app and can optionally provide a description of what your app’s purpose is, tags, and app icon. 
![Create App Options](/img/DragAndDrop/CreateApp.png)

4. Click save! 

## Edit App
![Edit App Options](/img/DragAndDrop/EditApp.png)
...
3. **Variables**: This panel is used to manage variables within SEMOSSName. Variables can store data, intermediate results, or parameters that can be reused across different parts of a project. They help in making the analysis dynamic and flexible.
...
### Blocks
![Blocks](/img/DragAndDrop/BlockSettings.png)
...
![Input](/img/Navigating/Create%20New%20App/DND3.png)
...
![Divider](/img/Navigating/Create%20New%20App/DNDdivider.png)
...
![HTML](/img/Navigating/Create%20New%20App/DNDhtml.png)
...
![Input](/img/Navigating/Create%20New%20App/DNDinput.png)
...
![Python Prefix for Upload Block](/img/Navigating/Pythonprefixforuploadblock.png)
...
![App using Upload Block](/img/Navigating/UploadBlockApp.PNG)
...
![Layout](/img/Navigating/Create%20New%20App/DNDlayout.png)
...
![Text](/img/Navigating/Create%20New%20App/DNDtext.png)
...
![Theme](/img/Navigating/Create%20New%20App/DNDtheme.png)
...
![Layers](/img/Navigating/Create%20New%20App/DNDlayers.png)
...
![Scripting Language](/img/Navigating/Create%20New%20App/NB1.png)
...
Under cells, we can choose either a **Code** cell, represented by a **\<\> cell**, or a **Import Data** cell, and then write code or a query to access SEMOSSName resources as per app requirements.

![Multiple cells](/img/Navigating/Create%20New%20App/NB2.png)

If we choose a Code cell, we can navigate to the SEMOSSName resource (Model, Database, Storage, Vector Database, etc.) we want to connect with the app and click on the usage tab within the resource. We can copy the code based on the scripting language chosen for the cell and paste it into the Notebook query cell. This code can be modified or customized altogether.

![Model Usage](/img/Navigating/Create%20New%20App/NB3.png)

In a Import Data cell, we can write a database query and select the Database from the list of accessible databases. 

![Database drop-down list](/img/Navigating/Create%20New%20App/NB4.png)
...
![Data Frame](/img/Navigating/Create%20New%20App/NB5.png)
...
![Transformation](/img/Navigating/Create%20New%20App/NB6.png)
...
![Transformation Uppercase](/img/Navigating/Create%20New%20App/NB7.png)
...
![Create variables](/img/Navigating/Create%20New%20App/VAR1.png)
...
![Input variables](/img/Navigating/Create%20New%20App/VAR2.png)
...
![Connect Query ID with UI Block](/img/Navigating/Create%20New%20App/VAR3.png)
...
![Link Query with Action Block](/img/Navigating/Create%20New%20App/VAR4.png)
...
![Page Query](/img/Navigating/Create%20New%20App/VAR5.png)
...
![UI Built Application](/img/Navigating/Create%20New%20App/VAR7.png)


## Settings 
- Click on **Settings** to set the accessibility of the App and to delete the App as shown below.

![Settings Icon](/img/Navigating/Create%20New%20App/VAR6.png)
...
## Blocks Guide
<ShowVideoTag><ReactPlayer controls url="/Demos/BlockGuideDemo.mp4" /></ShowVideoTag>
...
![Browse Template Block Guide](/img/Navigating/BrowseTemplateBlockGuide.PNG)
...
![Block Guide App](/img/Navigating/BlockGuideApp.PNG)
...
![Data tab with queries](/img/Navigating/Datatabwithqueries.PNG)
...
![Created App](/img/Navigating/NewAppThroughBlockGuide.PNG)
...
<ShowVideoTag><ReactPlayer controls url="/Demos/AccessingLLMsInDragAndDrop.mp4" /></ShowVideoTag>

### Button
Demo how to integrate a button into a drag and drop app and run a query
<ShowVideoTag><ReactPlayer controls url="/Demos/DragandDropDemo.mp4" /></ShowVideoTag>
