...
3. Download the starter Maven project from [here](/assets/CustomReactorGuide.zip)
...
![Maven Folder Setup](/img/CustomReactor/maven-project-folder-setup.png)
...
![JUnit](/img/CustomReactor/junit-success.png)
