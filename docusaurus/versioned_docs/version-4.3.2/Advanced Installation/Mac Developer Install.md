...
## SEMOSSName Installation for Mac Silicon
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture%201.png)

### Set Up your SEMOSSName Dev Directory
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture2.png)

## Prerequisites

Download softwares and tools from below links to be able to install SEMOSSName.

### Create SEMOSSName and workspace Folders
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture3.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture4.png)

### Install Homebrew- Option 2/2
- Before proceeding, make sure that you have elevated permissions with the yellow unlocked icon in the dock
...
- It will ask you for your password several times – continue to type it in until the installation is complete
  ...
  - `sudo vim /etc/pam.d/sudo` (use whichever text editor you're comfortable with)
    - Make a space under the very top commented line and add this line: `auth sufficient pam_tid.so`, then make sure to save overriding the readonly option.
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture5.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture6.png)
...
<!-- ![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture7.png) -->

### Install nvm
- nvm is a node version management tool for macOS
  - Go to https://github.com/nvm-sh/nvm to check out the latest build
- Open iTerm (or regular Terminal if skipped)
- Run:
```bash
curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.3/install.sh | bash
```
- Edit ~/.zshrc (this can be done through nano/vim on command line or VS code
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture9.png)

### Download Java
- Download a Java 21 JDS – We use Azul Zulu Builds of OpenJDK
- Navigate to https://www.azul.com/downloads/?version=java-21-lts&os=macos&architecture=arm-64-bit&package=jdk-fx#zulu
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture10.png)
...
<!-- ![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture11.png) -->
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Picture12.png)

### Maven

Click on [Maven](https://maven.apache.org/download.cgi)
- Click the download link beside Binary zip archive, and unzip this to your Documents/SEMOSS folder
- Then, in your .zshrc, add the following lines:
```zsh
export M2_HOME="$HOME/Documents/SEMOSS/apache-maven-3.9.10"
...
cd ~/Documents/SEMOSS/workspace/apache-tomcat-9.*/webapps/
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Picture13.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Picture14.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac1.png)

![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac2.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac3.png)

![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac4.png)

![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac5.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac6.png)

![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac7.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac8.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac9.png)
...
![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac10.png)

### Start Tomcat Server
- Right click “Tomcat v9.0 Server at localhost” under the “Servers” tab
- Select “Start”
...
``` 
To add extra cpu run this command
```
uv pip install -r pyproject.toml --extra cpu
``` 
To add extra gpu run this command 
```
...
Add the following to your .zshrc if you plan to run this specific python installation locally:
```zsh
export VIRTUAL_ENV="path/to/your/python/venv"
...
- Edit Line starting with LD_LIBRARY_PATH:
 ...
 ![SEMOSSName](/versioned/4.3.2/img/SemossDevInstallation/Mac14.png)
