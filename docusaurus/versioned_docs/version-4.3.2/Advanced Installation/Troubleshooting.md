...
![Tomcat Server](/versioned/4.3.2/img/BELocalInstall/ts1.png)
...
![Tomcat Server](/versioned/4.3.2/img/BELocalInstall/ts2.png)


## Regarding SEMOSSName Update
...
![Semoss](/versioned/4.3.2/img/SemossDevInstallation/GitStatusOutput.jpg)
Note that if you try to git pull without stashing your local changes, you will get a warning message:
![Semoss](/versioned/4.3.2/img/SemossDevInstallation/GitPullConflict.jpg)
...
- Run `git pull` to pull in the latest changes from the dev branch.
  ...
  ![Semoss](/versioned/4.3.2/img/SemossDevInstallation/GitPullOutput.jpg)
...
![Semoss](/versioned/4.3.2/img/SemossDevInstallation/GitStashPopOutput.jpg)
...
![Semoss](/versioned/4.3.2/img/SemossDevInstallation/GitStashPopConflict.jpg)
...
![Semoss](/versioned/4.3.2/img/SemossDevInstallation/ResolveConflict.jpg)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick9.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick10.png)

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick11.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick12.png)
...
- After you update you should follow these steps within Eclipse in order to ensure your Semoss and Monolith projects are fully operational,
	...
	- Refresh your code
	- Right click on your Semoss and Monolith projects in the left hand panel of Eclipse and click Refresh to do this before starting SEMOSSName
	- Clean your projects
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick13.png)

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick14.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick15.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick16.png)

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick17.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick18.png)

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick19.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick20.jpg)

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick21.png)

- Edit JAVA_HOME variable with the path you copied before

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick22.png)

- Edit JRE_HOME with the path you copied before + \jre

![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick23.png)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick24.png)
...
![Tomcat Error](</versioned/4.3.2/img/SemossDevInstallation/tomcat error.png>)
...
![SEMOSS](/versioned/4.3.2/img/SemossDevInstallation/Trick25.png)
