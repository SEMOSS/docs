...
- Select the link under ‘Download Links’ -> ![Eclipse download link](/versioned/4.3.2/img/SemossDevInstallation/EclipseDownloadLink.png)
- Windows 64-bit
...
![Workspace Folder](/versioned/4.3.2/img/SemossDevInstallation/WorkspaceFolder.png)
...
![env local file](/versioned/4.3.2/img/BELocalInstall/semoss-ui-env-local.png)
...
![Workspace Launcher](/versioned/4.3.2/img/SemossDevInstallation/WorkspaceLauncher.png)
...
![Import Maven Projects_Root Directory](/versioned/4.3.2/img/SemossDevInstallation/Import%20Maven%20Projects.png)
...
![Import Maven Projects_Projects](/versioned/4.3.2/img/SemossDevInstallation/ImportMavenProject_Projects.png)
...
![Build Path](/versioned/4.3.2/img/SemossDevInstallation/BuildPath.png)

- Click on the Source tab, Select the **Monolith/src** folder and click Edit.
![Monolith folder in java](/versioned/4.3.2/img/SemossDevInstallation/Monolithfolderinjava.png)
...
![Edit source folder](/versioned/4.3.2/img/SemossDevInstallation/Editsourcefolder.png)

## Setup RDF_MAP

### Update RDF Map for Semoss
- In the **Project Explorer** panel on the left, expand Semoss and scroll down to find File.
![Project Explorer](/versioned/4.3.2/img/SemossDevInstallation/ProjectExplorer.png)

- Right click on **RDF_Map.prop** and Open With Notepad++ or double click and just open in Eclipse
![RFP_Map in Folder](/versioned/4.3.2/img/SemossDevInstallation/RDP_MapinFolder.png)
...
![Edit Path](/versioned/4.3.2/img/SemossDevInstallation/EditPath.png)
...
- Ensure that every port and folder name matches with how you set up your SEMOSSName.
  - Ports 5353/5355/8080 should be changed to 9090 (should be changed already)
  - SemossWeb_AppUi should be changed to SemossWeb
  - Monolith should match what you called your Monolith folder (note: should be "Monolith", not "monolith")
...
![Pic 1](/versioned/4.3.2/img/SemossDevInstallation/Pic1.png)
![Pic 2](/versioned/4.3.2/img/SemossDevInstallation/Pic2.png)
![Pic 3](/versioned/4.3.2/img/SemossDevInstallation/Pic3.png)
![Pic 4](/versioned/4.3.2/img/SemossDevInstallation/Pic4.png)
...
![server.xml](/versioned/4.3.2/img/SemossDevInstallation/server.xml.png)
...
![Servers](/versioned/4.3.2/img/SemossDevInstallation/Servers.png)
...
![Expanded Servers](/versioned/4.3.2/img/SemossDevInstallation/ExpandedServer.png)
...
![New Server](/versioned/4.3.2/img/SemossDevInstallation/NewServer.png)
...
![Add and Remove](/versioned/4.3.2/img/SemossDevInstallation/AddandRemove.png)

- Back in Eclipse, in the bottom panel area, on the Servers tab, double-click your new server (Tomcat v9.0 Server at localhost).
![Servers Tab](/versioned/4.3.2/img/SemossDevInstallation/Servertab.png)
...
![Module tab](/versioned/4.3.2/img/SemossDevInstallation/Moduletab.png)

- Select the Monolith Web Module that appears in the table and click Edit on the right
![Web Module](/versioned/4.3.2/img/SemossDevInstallation/Webmodule.png)
...
![Environment Variables](/versioned/4.3.2/img/SemossDevInstallation/EnvironmentVariables.png)
...
- Click OK
![System Variables](/versioned/4.3.2/img/SemossDevInstallation/SystemVariable.png)
...
![Path variable](/versioned/4.3.2/img/SemossDevInstallation/Pathvariable.png)
...
![System variable 2](/versioned/4.3.2/img/SemossDevInstallation/Systemvariable2.png)
...
![Path variable 2](/versioned/4.3.2/img/SemossDevInstallation/Pathvariable2.png)
...
![web.xml](/versioned/4.3.2/img/SemossDevInstallation/web.xml.png)
...
![WSS Agent](/versioned/4.3.2/img/SemossDevInstallation/WSSAgent.png)
...
![Command Prompt](/versioned/4.3.2/img/SemossDevInstallation/CommandPrompt.png)
...
- Hit Enter
![line in command prompt](/versioned/4.3.2/img/SemossDevInstallation/Lineincommandprompt.png)
...
![System Explorer](/versioned/4.3.2/img/SemossDevInstallation/SystemExplorer.png)
...
![Command prompt to install maven](/versioned/4.3.2/img/SemossDevInstallation/CommandPrompttoinstallmaven.png)

  - Copy and right-click to paste the following line into the command prompt, and hit enter:
    - mvn clean install -U -DskipTests=true
    
![Run command](/versioned/4.3.2/img/SemossDevInstallation/RunCommand.png)
...
![Cataline.properties file](/versioned/4.3.2/img/SemossDevInstallation/cataline.propertiesfile.png)
...
![Project Explorer](/versioned/4.3.2/img/SemossDevInstallation/ProjectExplorer_updatemaven.png)
...
![Maven Progress](/versioned/4.3.2/img/SemossDevInstallation/MavenProgress.png)

  - If you get the following error while maven updating, just click ok and let the update proceed.

![Error](/versioned/4.3.2/img/SemossDevInstallation/Error.jpg)
...
- Set Java 21 as the default JRE​
  ![java update](/versioned/4.3.2/img/SemossDevInstallation/java21.png)
...
![java update](/versioned/4.3.2/img/SemossDevInstallation/java21-1.png)
### Start Semoss Web
...
![Java Build Path - Monolith](/versioned/4.3.2/img/SemossDevInstallation/JavaBuildPath-Monolith.png)
...
![Server Module](/versioned/4.3.2/img/SemossDevInstallation/ServerModule.png)
...
![Semoss Started](/versioned/4.3.2/img/SemossDevInstallation/SemossStarted.jpg)
...
- Depending on what you are using SEMOSSName for, install the packages in order:
  - SEMOSS:
  ```
...
![RDF_Map Python](/versioned/4.3.2/img/BELocalInstall/PythonProps.png)
...
3. You now have 2 options, you can either:
    ...
    - **OR**
    - Add the PYTHONHOME variable (from the virtual environment folder) to your system environment variables
...
![Setup R](/versioned/4.3.2/img/SemossDevInstallation/SetupR.png)
...
![Environment Variables R](/versioned/4.3.2/img/SemossDevInstallation/REnvironmentVariables.png)
...
![R Terminal](/versioned/4.3.2/img/SemossDevInstallation/RTerminal.png)
