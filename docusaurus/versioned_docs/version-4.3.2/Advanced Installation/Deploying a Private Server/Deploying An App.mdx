...
3. **SEMOSSName Account**: You need an account on the SEMOSSName platform.
...
- **Username**: Enter your SEMOSSName username.
- **Password**: Enter your SEMOSSName password.

## Create New App in SEMOSSName
