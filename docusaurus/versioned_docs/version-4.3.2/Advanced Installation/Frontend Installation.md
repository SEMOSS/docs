...
![Cloning](/versioned/4.3.2/img/FELocalInstall/gitClone.png)

Once you have this link you can go back to your open terminal and clone the repository into your webapps folder. 

![terminal cloning](/versioned/4.3.2/img/FELocalInstall/cloning.PNG)
...
![VS Code terminal](/versioned/4.3.2/img/FELocalInstall/semossuiterminal.PNG)
...
![local env](/versioned/4.3.2/img/FELocalInstall/envlocal.png)
...
![Registering](/versioned/4.3.2/img/FELocalInstall/registering.png)
...
![Final Page](/versioned/4.3.2/img/FELocalInstall/finalPage.PNG)
