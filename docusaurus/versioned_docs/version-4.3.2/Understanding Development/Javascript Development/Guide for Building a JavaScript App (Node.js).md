...
## Examples
You can see app examples in the [SEMOSSName Apps](https://github.com/semoss-Default/training) repo. Feel free to download an existing app and use it as scaffold for building your own! Existing work can be used to experiment and learn.
> **Note**
...
See the Environment Variables section of [Connecting to the Demmo  App](../Establish%20Connection%20to%20 %20Portal/ConnectingToAI.md)
...
See [Connecting to  ](../Establish%20Connection%20to%20 %20Portal/Connecting%20to%20 %20AI.md) for documentation on how to set up your app with API keys to be added as environment variables.

## Using the SEMOSS SDK

Learn more about how to use the SEMOSS SDK in the [Using the SDK](../Establish%20Connection%20to%20 %20Portal/Using%20the%20SDK.md) guide.
...
## Adding Your App to the SEMOSSName App Catalog
...
![Create New App](/versioned/4.3.2/img/AppUseCaseImages/app_building_options.png)
...
![Upload App Assets Button](/versioned/4.3.2/img/AppUseCaseImages/code_editor_asset_upload.png)
5. Attach your zip file in the modal that appears and hit "Upload."
![Upload App Assets Modal](/versioned/4.3.2/img/AppUseCaseImages/asset_upload_dialog.png)
...
![Edit App](/versioned/4.3.2/img/UpdateApp/demoAPP_edit.PNG)
4. Once in the Edit App tab, navigate to the Settings Tab. 
![Settings Tab](/versioned/4.3.2/img/UpdateApp/DemoApp_settings.PNG)
5. Once in the settings section, you want to go to the Data Apps Section. 
![Data Apps](/versioned/4.3.2/img/UpdateApp/DemoApp_data.PNG)
...
![Update App](/versioned/4.3.2/img/UpdateApp/DemoApp_update.PNG)
