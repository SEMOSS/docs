---
title: "JUnit Tests"
description: "A guide to writing unit tests in SEMOSS"
---

import AppName, { DynamicCodeBlock } from "@site/src/components/CustomFields";


# How To Write Unit Tests in SEMOSSName


Unit testing helps ensure code is reliable, maintainable, and functions as expected in isolation. In SEMOSSName, we use **JUnit** for testing and **Mockito** for mocking, while following a consistent folder structure to keep tests organized and discoverable.

This guide will walk through:

- SEMOSSName's expected test directory structure
...
SEMOSSName follows a mirrored structure between main and test sources. This helps maintain clarity and consistency when navigating between classes and their test cases.
...
JUnit is used for defining and running test cases. SEMOSSName projects generally use JUnit 5.
...
SEMOSSName already includes a rich set of unit tests. If you’re unsure how to test something, look around:
...
**Next Steps** \
	...
	•	Reach out to your team or the CFG AI support group at [support-email](mailto:support-email) if you’re not sure how to test a specific component.
