...
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/Accordion.jpg)
...
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionLanding.jpeg)

Within the block settings you will be able to see many different setting options that you can choose
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionBlockSettings.png)

### Appearance
In this section, you can decide the Variant, Color, and Size of your Accordion.

### Show Expand Icon
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionContent.png)

If you want the Accordion to expand, select 'Show Expand Icon'.

#### Spacing
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionSpacing.png)

- **Margin:** Set the margin for the Accordion.
- **Padding:** Set the padding for the Accordion.

#### Dimensions
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionDimensions.png)
...
#### Color
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionColor.png)
...
#### Border
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/AccordionBorder.png)
