---
sidebar_label: "Layers Panel"
sidebar_position: 1
slug: "system-components/layers-panel"
---

# Layers Panel
SEMOSS allows you to easily create an app using drag-and-drop features. 
...
![CatalogPage](/versioned/4.3.2/img/DragAndDrop/CreateNewApp.jpg)

Choose the "Drag and Drop" editor option.
![EditorPage](/versioned/4.3.2/img/DragAndDrop/DragAndDropLanding.jpg)

Once your app editor opens, select the "Layers" tab from the left hand menu.
![AppLanding](/versioned/4.3.2/img/DragAndDrop/AppLanding.jpg)

This will expand the Layers panel.
![LayersMenu](/versioned/4.3.2/img/DragAndDrop/LayersLanding.jpg)
...
![BlocksMenu](/versioned/4.3.2/img/DragAndDrop/BlocksMenu.jpg)
...
![OneContainer](/versioned/4.3.2/img/DragAndDrop/OneContainer.jpg)
...
![NestBlock](/versioned/4.3.2/img/DragAndDrop/NestBlock.jpg)

You can un-nest blocks in the same manner by dragging them out of the parent container in the layers panel:
![UnnestBlock](/versioned/4.3.2/img/DragAndDrop/UnnestBlock.jpg)
...
![ReorderBlock](/versioned/4.3.2/img/DragAndDrop/ReorderBlock.jpg)

The layers panel displays blocks in order from top to bottom, left to right.
![ReorderBlock2](/versioned/4.3.2/img/DragAndDrop/ReorderBlock2.jpg)
...
![TwoContainers](/versioned/4.3.2/img/DragAndDrop/TwoContainers.jpg)
...
![AddPage](/versioned/4.3.2/img/DragAndDrop/NewPage.jpg)
...
![SwitchPage](/versioned/4.3.2/img/DragAndDrop/SwitchPage.jpg)
