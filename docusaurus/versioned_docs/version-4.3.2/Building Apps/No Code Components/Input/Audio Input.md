---
sidebar_label: 'Audio Input Block'
sidebar_position: 1
slug: '/audio input-block'
---
...
![Audio Input](/versioned/4.3.2/img/Systemcomponents/Audio1.png)

If you select Recording-
You need to provide the mp3 (or any other audio extension) link of the recording.

![Audio Input](/versioned/4.3.2/img/Systemcomponents/Audio2.png)
