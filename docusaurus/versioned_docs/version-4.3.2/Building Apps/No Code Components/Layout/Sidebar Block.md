...
sidebar_position: 1
slug: "system-components/sidebar-menu"
---
# Sidebar Menu Block
...
![BlocksMenu](/versioned/4.3.2/img/SidebarMenu/BlocksMenu.jpg)

Drag the "Sidebar" block into your page.
![SidebarLanding](/versioned/4.3.2/img/SidebarMenu/SidebarLanding.jpg)
...
![DragLink](/versioned/4.3.2/img/SidebarMenu/DragLink.jpg)

After your links appear, you can view them in the layers panel nested under the Sidebar block.
![NestedLinks](/versioned/4.3.2/img/SidebarMenu/NestedLinks.jpg)
...
![BlockSettingsPanel](/versioned/4.3.2/img/SidebarMenu/BlockSettingsPanel.jpg)

This will open a menu with customization options for the sidebar menu.
![SidebarSettings](/versioned/4.3.2/img/SidebarMenu/SidebarSettings.jpg)
...
![OpenState](/versioned/4.3.2/img/SidebarMenu/OpenState.jpg)

In addition, you can also customize the sidebar's visual traits like the color, alignment, border, padding, etc. 
![VisualOptions](/versioned/4.3.2/img/SidebarMenu/VisualOptions.jpg)
