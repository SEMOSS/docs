...
![Build](/versioned/4.3.2/img/Pro%20Code/CreateProCode.png)
3. Enter your app details:
![Create Pro Code App](/versioned/4.3.2/img/Pro%20Code/CreateApp.png)
...
![Create Pro Code App](/versioned/4.3.2/img/Pro%20Code/CreateSave.png)

## Edit App

SEMOSSName allows users to view and edit files in real time. You can edit your app files, manage your app settings, and publish your app by clicking the green **<span className="text-green">Edit</span>** button in the top right corner of your app.

![Edit Button](/versioned/4.3.2/img/Pro%20Code/EditApp.png)

### Files

In the SEMOSS UI editor, you’ll see a file explorer panel with a folder named **portals**.
...
![File Structure](/versioned/4.3.2/img/Pro%20Code/FileStructure.png)
...
To find these resources on your computer:

- Navigate to workspace/Semoss/project/[YourAppName]_[your-app-id]/app_root/version/.
- Within the version directory, you'll see the assets folder. This folder contains **portals** and its key file, **portals/index.html.**
...
2. Click on **Edit**
3. Open the **Files** menu. You can see folders and files.
4. Click on the file you want to edit. For example let's edit the default app created. To do this click on **portals/index.html**. SEMOSSName opens the file contents and allows you to edit the HTML!
![Edit HTML File](/versioned/4.3.2/img/Pro%20Code/EditFile.png)

5. Finally save your work! If the file has been edited there will be a **\*** at the end of the file name. Click on the save button.
![Save HTML File](/versioned/4.3.2/img/Pro%20Code/SaveFile.png)

The code editor allows you to edit files, to see the changes for your app you must [publish](#publish-files)  your changes!

#### Publish Files

![Publish Files](/versioned/4.3.2/img/Pro%20Code/PublishFiles.png)
...
![Recompile Reactors](/versioned/4.3.2/img/Pro%20Code/RecompileReactors.png)
...
![Upload Files](/versioned/4.3.2/img/Pro%20Code/UploadFiles.png)

Use this feature to add new files to your project from your computer.

![Upload to Portals](/versioned/4.3.2/img/Pro%20Code/PortalsUpload.png)
...
![Create New File](/versioned/4.3.2/img/Pro%20Code/CreateNewFile.png)
...
![Create New Folder](/versioned/4.3.2/img/Pro%20Code/CreateNewFolder.png)
...
![Terminal](/versioned/4.3.2/img/Pro%20Code/Terminal.png)
...
![Settings Icon](/versioned/4.3.2/img/Pro%20Code/Settings.png)
...
![Member Settings](/versioned/4.3.2/img/Pro%20Code/MemberSettings.png)
...
![Pending Requests](/versioned/4.3.2/img/Pro%20Code/Pending.png)
...
![App Settings](/versioned/4.3.2/img/Pro%20Code/AppSettings.png)
...
![Publish Project](/versioned/4.3.2/img/Pro%20Code/PublishProject.png)

The generated link will contain your created app/project and you can share this with anyone.

#### Reactors

![Reactors](/versioned/4.3.2/img/Pro%20Code/Reactors.png)
...
![SuccessfullyRecompiled](/versioned/4.3.2/img/Pro%20Code/SuccessfullyRecompiled.png)
...
![Redeployed](/versioned/4.3.2/img/Pro%20Code/Redeployed.png)
...
![Access Settings](/versioned/4.3.2/img/Pro%20Code/AccessSettings.png)
...
![Private](/versioned/4.3.2/img/Pro%20Code/Private.png)
...
![NonDiscoverable](/versioned/4.3.2/img/Pro%20Code/NonDiscoverable.png)
...
![Discoverable](/versioned/4.3.2/img/Pro%20Code/Discoverable.png)

#### Delete App
<!-- We can copy existing content for this -->
Authors can permanently delete an app.

![Delete App](/versioned/4.3.2/img/Pro%20Code/DeleteApp.png)
...
![Share App](/versioned/4.3.2/img/Pro%20Code/ShareToggle.png)
...
![Share URL](/versioned/4.3.2/img/Pro%20Code/ShareURL.png)
...
![Share IFrame](/versioned/4.3.2/img/Pro%20Code/ShareIFrame.png)
...
![Bookmark](/versioned/4.3.2/img/Pro%20Code/Bookmark.png)

This will pin it to the top of your collection for quick and easy access from the **My Apps** tab.

![App Page Bookmark](/versioned/4.3.2/img/Pro%20Code/AppPageBookmark.png)
