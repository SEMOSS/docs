...
<ReactPlayer controls url="/versioned/4.3.2/demos/IntroToDragAndDrop.mp4" />
<br/>
...
![App Library Home](/versioned/4.3.2/img/AppUseCaseImages/AppBuildingOptionsNew.png)

3. Add a name for your new app and can optionally provide a description of what your app’s purpose is, tags, and app icon. 
![Create App Options](/versioned/4.3.2/img/DragAndDrop/CreateApp.png)

4. Click save! 

## Edit App
![Edit App Options](/versioned/4.3.2/img/DragAndDrop/EditApp.png)
...
3. **Variables**: This panel is used to manage variables within SEMOSS. Variables can store data, intermediate results, or parameters that can be reused across different parts of a project. They help in making the analysis dynamic and flexible.
...
### Blocks
![Blocks](/versioned/4.3.2/img/DragAndDrop/BlockSettings.png)
...
![Input](/versioned/4.3.2/img/Navigating/Create%20New%20App/DND3.png)
...
![Divider](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDdivider.png)
...
![HTML](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDhtml.png)
...
![Input](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDinput.png)
...
![Python Prefix for Upload Block](/versioned/4.3.2/img/Navigating/Pythonprefixforuploadblock.png)
...
![App using Upload Block](/versioned/4.3.2/img/Navigating/UploadBlockApp.PNG)
...
![Layout](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDlayout.png)
...
![Text](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDtext.png)
...
![Theme](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDtheme.png)
...
![Layers](/versioned/4.3.2/img/Navigating/Create%20New%20App/DNDlayers.png)
...
![Scripting Language](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB1.png)
...
Under cells, we can choose either a **Code** cell, represented by a **\<\> cell**, or a **Import Data** cell, and then write code or a query to access SEMOSS resources as per app requirements.

![Multiple cells](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB2.png)

If we choose a Code cell, we can navigate to the SEMOSS resource (Model, Database, Storage, Vector Database, etc.) we want to connect with the app and click on the usage tab within the resource. We can copy the code based on the scripting language chosen for the cell and paste it into the Notebook query cell. This code can be modified or customized altogether.

![Model Usage](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB3.png)

In a Import Data cell, we can write a database query and select the Database from the list of accessible databases. 

![Database drop-down list](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB4.png)
...
![Data Frame](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB5.png)
...
![Transformation](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB6.png)
...
![Transformation Uppercase](/versioned/4.3.2/img/Navigating/Create%20New%20App/NB7.png)
...
![Create variables](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR1.png)
...
![Input variables](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR2.png)
...
![Connect Query ID with UI Block](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR3.png)
...
![Link Query with Action Block](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR4.png)
...
![Page Query](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR5.png)
...
![UI Built Application](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR7.png)


## Settings 
- Click on **Settings** to set the accessibility of the App and to delete the App as shown below.

![Settings Icon](/versioned/4.3.2/img/Navigating/Create%20New%20App/VAR6.png)
...
## Blocks Guide
<ReactPlayer controls url="/versioned/4.3.2/demos/BlockGuideDemo.mp4" />
...
![Browse Template Block Guide](/versioned/4.3.2/img/Navigating/BrowseTemplateBlockGuide.PNG)
...
![Block Guide App](/versioned/4.3.2/img/Navigating/BlockGuideApp.PNG)
...
![Delete block](/versioned/4.3.2/img/Navigating/Delete%20Block.PNG)

We can modify configuration of blocks as required by the App by changing details on the right side of a block.

![Modifying block](/versioned/4.3.2/img/Navigating/Modifying%20Block.PNG)
...
![Data tab with queries](/versioned/4.3.2/img/Navigating/Datatabwithqueries.PNG)
...
![Created App](/versioned/4.3.2/img/Navigating/NewAppThroughBlockGuide.PNG)
...
<ReactPlayer controls url="/versioned/4.3.2/demos/AccessingLLMsInDragAndDrop.mp4" />

### Button
Demo how to integrate a button into a drag and drop app and run a query
<ReactPlayer controls url="/versioned/4.3.2/demos/DragandDropDemo.mp4" />
