...
In SEMOSSName, an app is a customizable GenAI solution built on a low-code platform with configurable components. Advanced users can upload web-based applications. These apps are accessible and modifiable through the App Library.

### Why Create an App?

Developing an app on the SEMOSSName platform offers several benefits:
...
- **Data Integration**: Integrate SEMOSSName apps with various data sources for comprehensive data analysis and visualization, supporting better decision-making.
...
App development on the SEMOSSName platform can involve various stakeholders, including:
...
### SEMOSSName App Options

![App Library Home](/versioned/4.3.2/img/AppUseCaseImages/AppBuildingOptionsNew.png)

In SEMOSSName, there are three different ways to create apps: Agent Builder, Drag and Drop, and Code. Here’s a brief overview of each method and the type of user who might prefer it:
...
Each method caters to different user skill levels and needs, ensuring that SEMOSSName can be effectively used by a wide range of professionals within an organization. We will go over each Create New App method in detail.
