...
![AppLibraryl](/versioned/4.3.2/img/Navigating/AppLibrary_BI.png)
...
![NewProject](/versioned/4.3.2/img/Navigating/CreateProject.png)
...
![CreateInsight](/versioned/4.3.2/img/Navigating/CreateInsight.png)
...
![Adding a Panel](/versioned/4.3.2/img/Navigating/panel.png)
...
![Presentation Mode](/versioned/4.3.2/img/Navigating/Presentation.png)
...
![Export](/versioned/4.3.2/img/Navigating/exporting.png)
> By going into export, we can make this into a shareable file.

<ReactPlayer controls url="/versioned/4.3.2/demos/BIToolDemo.mp4" />
...
![Text2SQL](/versioned/4.3.2/img/Navigating/SEMOSS%20AI%20Apps/Text%20to%20SQL.PNG)
> Text2SQL App response based on uploaded file and question asked

<ReactPlayer controls url="/versioned/4.3.2/demos/Text2SQLAppDemo.mp4" />
...
![Policy Vector Engine](/versioned/4.3.2/img/Navigating/SEMOSS%20AI%20Apps/PolicyVectorEngine.PNG)
> Policy Vector Engine response to a question

<ReactPlayer controls url="/versioned/4.3.2/demos/PolicyVectorEngine.mp4" />
...
![Playground App](/versioned/4.3.2/img/Navigating/SEMOSS%20AI%20Apps/Playground.PNG)
...
![Report Generator App](/versioned/4.3.2/img/Navigating/SEMOSS%20AI%20Apps/Report_Generator_Response.PNG)
> Report Generator App response to a meetring transcript as a prompt

<ReactPlayer controls url="/versioned/4.3.2/demos/ReportGeneratorApp.mp4" />
...
![Copy Apps Folder link](/versioned/4.3.2/img/Navigating/Copy%20Apps%20Folder%20code.PNG)
> Apps folder link

Now open the folder in your local environment where you want to download these Apps and run the windows terminal.
![Github Folder](/versioned/4.3.2/img/Navigating/Github%20Folder.PNG)
...
![Github Authnetication](/versioned/4.3.2/img/Navigating/Sign%20into%20Github.PNG)
...
![Apps Successfully Cloned](/versioned/4.3.2/img/Navigating/Successfully%20Cloned.PNG)
> Apps are successfully cloned locally

You can see below, cfgai-apps folder with other Apps in the folder.
![Apps cloned locally](/versioned/4.3.2/img/Navigating/All%20Apps%20cloned.PNG)
...
![Downloaded Zip File](/versioned/4.3.2/img/Navigating/Downloaded%20Zip%20File.PNG)
> Downloaded Zip File

Now unzip the file in the same folder and it will return cfgai-apps folder which will consist of all Apps in the folder.
![Unzipped Folder](/versioned/4.3.2/img/Navigating/unzipped%20folder.PNG)
> Downloaded Apps after unzipping the Folder


### Configure SMSS File
SMSS file allows SEMOSS to use resources of many different types, and allows users to configure certain properties of those resources being used. It is a file that sets the properties for resources like SEMOSS Engine, Project, Insight, Model, etc. It contains a list of key value pairs that set the context for SEMOSS objects.

For example, an engine's smss file may contain the ID in the SEMOSS database, the alias for the engine, JDBC connection, the location of the database file, username, password, etc. This allows SEMOSS to know how to connect to the object that the SMSS file references.
