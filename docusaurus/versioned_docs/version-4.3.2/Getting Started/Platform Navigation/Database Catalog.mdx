...
To navigate to the Database Catalog, click on the **cylinderical** icon on the left side of SEMOSS portal which will take you to Data catalog.
...
## Adding a Database
<ReactPlayer controls url="/versioned/4.3.2/demos/DatabaseCatalog.mp4" />

To connect to an existing Database or add a new Database, click on **Add Database**
![Database catalog](/versioned/4.3.2/autoImg/PlatformNavigation/Database%20Catalog/Add%20Database.png)


{/* You will be directed to the **Add Source** page which will have various options within the Database section mentioned below.

![Add Database](/versioned/4.3.2/img/Navigating/SEMOSS%20AI%20Walkthrough/Database%20Options.PNG) */}
...
![Database Options](/versioned/4.3.2/autoImg/PlatformNavigation/Database%20Catalog/Database%20Options.png)
...
![Postgres](/versioned/4.3.2/autoImg/PlatformNavigation/Database%20Catalog/Postgres%20Database.png)
...
![Usage tab of a Database](/versioned/4.3.2/autoImg/PlatformNavigation/Database%20Catalog/Usage.png)
...
![Database Access](/versioned/4.3.2/autoImg/PlatformNavigation/Database%20Catalog/Pending%20Requests.png)
...
## Export Database
The **Export** button allows users to download the current content as a ZIP file, making it easy to save and share multiple files in a compressed format. This feature streamlines the process of exporting data for backup, collaboration, or offline use. By clicking the Export button, users can quickly package their work and transfer it efficiently. This zipped file can be uploaded in other SEMOSS environments.
