...
![Storage icon](/versioned/4.3.2/autoImg/PlatformNavigation/Storage%20Catalog/Storage.png)
...
![Storage Catalogue](/versioned/4.3.2/autoImg/PlatformNavigation/Storage%20Catalog/Add%20Storage.png)
...
![Add Storage](/versioned/4.3.2/autoImg/PlatformNavigation/Storage%20Catalog/Amazon%20S3.png)
...
![Enter Storage Details](/versioned/4.3.2/autoImg/PlatformNavigation/Storage%20Catalog/Create%20storage.png)
...
![Storage Catalogue 2](/versioned/4.3.2/img/Navigating/SEMOSS%20AI%20Walkthrough/Storage%20Catalogue.png)

> _Newly added Storage_

<ReactPlayer controls url="/versioned/4.3.2/demos/StorageCatalog.mp4" />

## Usage

The Usage tab shows how to use the Storage in JavaScript, Python, Langchain API and Java.

![Usage of a Storage](/versioned/4.3.2/autoImg/PlatformNavigation/Storage%20Catalog/Usage.png)
...
![storage Access](/versioned/4.3.2/autoImg/PlatformNavigation/Storage%20Catalog/Pending%20Requests.png)
...
![Discoverable Storages](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Discoverable.png)
