...
![Click Open Function](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Function.png)
...
![Click Add Function](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Add%20Function.png)
...
![Select a Function](/versioned/4.3.2/img/FunctionEngines/azure.png)
...
![Configure a Function](/versioned/4.3.2/img/FunctionEngines/func-prop.png)
...
![Finalize a Function](/versioned/4.3.2/img/FunctionEngines/create_func.png)
...
![Add a Zipped Function Engine](/versioned/4.3.2/img/FunctionEngines/add_zip.png)


## Usage
The usage tab in a specific function engine tells you how to use the function in JavaScript, Python and Java.

![Usage of a Function](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Usage.png)
...
- ENGINE_ALIAS: engine name displayed in SEMOSS
- ENGINE_TYPE: Java class that implements SEMOSS engine interface (IEngine)
...
![Function Assets](/versioned/4.3.2/img/FunctionEngines/function_assets.png)
...
![App Access](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Pending%20Requests.png)
...
![Discoverable Functions](/versioned/4.3.2/img/FunctionEngines/discoverableFunction.png)
...
![Edit](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Edit.png)
...
![EditInterface](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Edit%20Function%20Options.png)
...
![Export](/versioned/4.3.2/autoImg/PlatformNavigation/Function%20Catalog/Export.png)
