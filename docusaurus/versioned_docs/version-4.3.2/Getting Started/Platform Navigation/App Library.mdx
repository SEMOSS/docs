...
App Library is a section in SEMOSS which consists of list of Gen AI applications present on the platform that are created by users. Once you click on a particular app in the App Library, it will open the App which is ready to use.

## Creating a new App

To create a new App, click on the top right corner of the homepage on **Create New App**.

![New App Button](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Create%20New%20App.png)
...
![Create New App Options](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Start%20build%20with%20a%20template.png)
...
![New App Popup](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/New%20App%20Popup.png)
...
![Preview App](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Preview%20App.png)
...
![Share App](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Share%20App.png)
...
![Sharing via Url](/versioned/4.3.2/img/AppSharing/UrlSharing.png)
...
![Sharing via Iframe](/versioned/4.3.2/img/AppSharing/IframeSharing.png)
...
![Save App](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Save%20App.png)
...
![Show App](/versioned/4.3.2/autoImg/PlatformNavigation/AppLibrary/ShowApp.png) */}
...
![Upload App](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Upload%20App.png)
...
![Uploading App](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Uploading%20App.png)

## Access Control
<ReactPlayer controls url="/Demos/AppLibraryAndUserPermissions.mp4" />
...
{/* TODO */}
{/* ![Access Control](/versioned/4.3.2/img/FunctionEngines/functionAccessControl.png) */}
...
![App Access](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Pending%20Requests.png)
...
![Discoverable Apps](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Discoverable.png)
...
![Request Access](/versioned/4.3.2/img/FunctionEngines/functionRequestAccess.png)
...
![Edit](/versioned/4.3.2/img/FunctionEngines/Edit.png)
...
![EditInterface](/versioned/4.3.2/img/FunctionEngines/EditInterface.png)



## Export App
The **Export** button allows users to download the current content as a ZIP file, making it easy to save and share multiple files in a compressed format. This feature streamlines the process of exporting data for backup, collaboration, or offline use. By clicking the Export button, users can quickly package their work and transfer it efficiently. This zipped file can be uploaded in other SEMOSS enviornments.
![Export](/versioned/4.3.2/img/FunctionEngines/Export.png)
...
![App Search](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Search.png)


## Removing an App
<ReactPlayer controls url="/versioned/4.3.2/demos/RemovingApp.mp4" />
...
![Settings Tool](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/Settings.png)
...
![App Settings](/versioned/4.3.2/autoImg/PlatformNavigation/App%20Library/App%20Settings.png)
...
![Delete Button](/versioned/4.3.2/img/Navigating/Navigating4.png)
