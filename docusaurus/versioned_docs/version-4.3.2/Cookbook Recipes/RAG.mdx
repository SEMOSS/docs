...
### Create an Agent
 ...
 3. Now, click **Get Started** Under **Construct an Agent**
  ![Creating an agent](/versioned/4.3.2/img/RAG/ConstructAnAgent.png)
 ...
 5. Click Next
  ![Creating HR Agent App](/versioned/4.3.2/img/RAG/HRAppCreation.png)
 6. Set Inputs, Use your mouse to hover over the word "Prompt". Then select **Set Input** and Click **Next**.
  ![Setting Input to HR App](/versioned/4.3.2/img/RAG/SettingPrompt.png)
...
![Testing HR App](/versioned/4.3.2/img/RAG/HRAppTest.png)
