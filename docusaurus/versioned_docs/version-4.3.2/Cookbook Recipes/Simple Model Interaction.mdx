...
Learn how to send a prompt to an AI model and receive a response using the Model in SEMOSSName. This recipe demonstrates a basic pro-code workflow for integrating a model into an application.
