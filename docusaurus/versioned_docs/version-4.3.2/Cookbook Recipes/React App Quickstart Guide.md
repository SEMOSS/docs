...
![Pic 2](/versioned/4.3.2/img/policyapp/Policy2pic.PNG)
> _Apps List_
...
![Pic 3](/versioned/4.3.2/img/policyapp/policy3pic.png)
> _Local Folder for Git Projects_

After you create the folder, navigate to it in a local terminal. 

![Pic4](/versioned/4.3.2/img/policyapp/policy4pic.PNG)
...
![pic7](/versioned/4.3.2/img/policyapp/policy7pic.PNG)
...
![pic8](/versioned/4.3.2/img/policyapp/policy8pic.png)
...
![pic9](/versioned/4.3.2/img/policyapp/policy9pic.PNG)
> _.env file in VS_

If you do not have these credentials, they are shown below for easy copy/pasting

```
ENDPOINT="https://YOUR_DEPLOYMENT_DOMAIN"
MODULE='/Monolith'
```
...
![Pic10](/versioned/4.3.2/img/policyapp/policy10pic.png)
> _Click on highlighted to create new file_

### Step 2: Generating an ACCESS_KEY and a SECRET_KEY

The following link will show you how to [generate an Access Key and a Secret Key](../Establish%20Connection%20to%20CFG%20Portal/ConnectingToAI.md).

Once you have those, populate your `.env.local` file with the proper codes. 

![Pic 11](/versioned/4.3.2/img/policyapp/policy11pic.PNG)
...
![Pic12](/versioned/4.3.2/img/policyapp/policy12pic.PNG)
...
![Pic13](/versioned/4.3.2/img/policyapp/policy13pic.PNG)
...
![Pic14](/versioned/4.3.2/img/policyapp/policy14pic.PNG)
...
2. Navigate to [App Library](https://YOUR_DEPLOYMENT_DOMAIN/SemossWeb/packages/client/dist/) and click "Create a New App" in the top right corner. This will bring you to the Create New App page.
