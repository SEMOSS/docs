...
## Examples
You can see app examples in the [SEMOSS Apps](ClientRepo) repo. Feel free to download an existing app and use it as scaffold for building your own! Existing work can be used to experiment and learn.
> **Note**
...
See the Environment Variables section of [Connecting to the CFG App](../Establish%20Connection%20to%20CFG%20Portal/ConnectingToAI.md)
...
See [Connecting to CFG](../Establish%20Connection%20to%20CFG%20Portal/ConnectingToAI.md) for documentation on how to set up your app with API keys to be added as environment variables.
...
<i> [webpack-dev-server] [HPM] Proxy created: /Monolith  -> https://YOUR_DEPLOYMENT_DOMAIN
