...
[Generate Access Key](../Establish%20Connection%20to%20CFG%20Portal/ConnectingToAI.md)
...
![Streamlit](/versioned/4.3.2/img/StreamlitImages/ai-server-chatbot-app.png)


We are going to make it use the AI Server's Model Engine Catalog by implementing the changes mentioned below -

![Streamlit](/versioned/4.3.2/img/StreamlitImages/update-steps.png)
...
[Chatbot.py Full code](https://github.com/semoss/cfgai-docs/blob/main/streamlit/CFG_Chatbot.py)
> **Note**
