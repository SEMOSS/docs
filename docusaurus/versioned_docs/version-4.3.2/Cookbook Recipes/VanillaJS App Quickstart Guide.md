...
![Demo App](/versioned/4.3.2/img/VanillaJS/Demo_App.png)


## Connecting to SEMOSS

- [Generating Access and Secret Keys](../Establish%20Connection%20to%20CFG%20Portal/ConnectingToAI.md)
...
![Importing Insight](/versioned/4.3.2/img/VanillaJS/ImportingInsight.PNG)
...
![Model Catalog](/versioned/4.3.2/img/VanillaJS/ModelCatalog.png)
...
![Requesting Access](/versioned/4.3.2/img/VanillaJS/RequestingAccess.PNG)
...
![Model Id](/versioned/4.3.2/img/VanillaJS/ModelID.PNG)
...
![Engine ID](/versioned/4.3.2/img/VanillaJS/Engine_ID.PNG)
...
![Portals](/versioned/4.3.2/img/VanillaJS/Portals_folder.png)
...
![Zip Files](/versioned/4.3.2/img/VanillaJS/Zip_file.png)
...
2. Click "Add App"
![Add App](/versioned/4.3.2/img/VanillaJS/Add_App.png)

3. Fill in the required fields 
![Requirements](/versioned/4.3.2/img/VanillaJS/Adding_Demo_App.PNG)
...
![Final](/versioned/4.3.2/img/VanillaJS/DemoApp_Added.PNG)
