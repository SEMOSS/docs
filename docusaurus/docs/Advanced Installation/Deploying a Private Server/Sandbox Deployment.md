...
* Login into https://quay.io/repository/semoss/semoss-dev/
* Copy the CLI secret from User Profile
* Log in to the Docker Registry and obtain CLI secret. Use the following command to log in to your Docker registry `docker login https://quay.io/repository/semoss/semoss-dev`
...
dockerImage=https://quay.io/semoss/semoss-dev:5.3.0-SNAPSHOT-ubuntu22-latest
````
...
````
* Copy the startHealthCheck.py from server-scripts folder.
