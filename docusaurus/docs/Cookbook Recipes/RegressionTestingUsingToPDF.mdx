---
title: Regression Testing Using ToPDF
description: Automate regression validation by converting application outputs to PDF for comparison and quality assurance.
...
tags:
  ...
  - ToPDF
  - QA
slug: /cookbook/regression-testing-topdf
---
...
You can use the **ToPdf** reactor to snapshot visualizations and dashboards for visual regression testing in SEMOSSName. This is useful when you want to ensure that your dashboards look the same after upgrading SEMOSSName to a new version.

The workflow is:
- Take screenshots of your dashboards using ToPdf on your current SEMOSSName version.
- After updating SEMOSSName, rerun ToPdf to generate new PDFs.
- Compare the new PDFs to the old ones to check for visual differences.

If the PDFs do not match, you know something has changed between the two SEMOSSName versions.
...
- **url**: The base URL for your SEMOSSName instance.
- **filePath**: The path where the PDF will be saved.


## Step-by-Step Guide

### 1. Open SEMOSSName Max II Max II Max II Max II Max Max in your browser

![SEMOSSName Home](/img/UseCases/SemossUrlCheck.jpeg)
...
- You can find these URLs in SEMOSSName by clicking “Share or Export” > “Embed” and copying the Embed URL.
...
<html>
  <head>
    <title>SEMOSSName Screenshot as PDF</title>
    <style>
      *{margin: 0; padding: 0;}
...
The base URL of your SEMOSSName instance, e.g.:
...
- Use the **Embed** feature in SEMOSSName to get the correct URLs for your dashboards.
...
With this approach, you can automate visual regression testing for your SEMOSSName dashboards using ToPdf!