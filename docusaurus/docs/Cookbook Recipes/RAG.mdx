...
description: Learn how to implement Retrieval Augmented Generation workflows using SEMOSS, create embeddings, and query knowledge sources.
...
### Create Vector Database
 ...
 ![Creating Vector DB](../../static/autoImg/RAG/HomeMenu.png)
 3. Click **Add Vector** in the top right corner of the vector catalog page. 
 ![Adding New Vector](../../static/autoImg/RAG/AddVectorDB.png)
...
### Create an Agent
 ...
 3. Now, click **Get Started** Under **Construct an Agent**
  ![Creating an agent](../../static/autoImg/RAG/ConstructAnAgent.png)
 ...
 6. Set Inputs, Use your mouse to hover over the word "Prompt". Then select **Set Input** and Click **Next**.
  ![Setting Input to HR App](../../static/autoImg/RAG/SettingPrompt.png)
