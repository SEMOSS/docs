...
description: Build and run a local Streamlit application that connects to SEMOSS models, storage, and databases for rapid prototyping.
...
## Change 3 ##
st.title("💬 Chatbot")
# Change the display reference from OpenAI LLM to SEMOSSName Max II Max II Max II Max II Max Max Server
