...
2. Save the app, then return to the SEMOSSName homepage. Find your app ID by clicking on the three dots icon on the lower right hand corner of the app, then click "Copy App ID" and save the copied ID to a safe place. ![App ID](../../../static/img/CustomReactor/AppID.jpg)
